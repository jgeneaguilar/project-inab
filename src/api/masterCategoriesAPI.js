...
export const createMasterCategory = (budgetId, masterCategoryName) => {
  ...
  return api.post(`budgets/${budgetId}/master_categories`, param).then((res) => res.data);
};

export const saveMasterCategory = (budgetId, masterCategoryId, newMasterCategoryName) => {
  const param = {
...
export const deleteMasterCategory = (budgetId, masterCategoryId) => {
  return api
    .delete(`budgets/${budgetId}/master_categories/${masterCategoryId}`)
    .then((res) => res.data);
};
